...
if __name__ == '__main__':
    ...
    parser.add_argument('--repeat', type=int, default=4, help="Repeat num.")
    ...
    parser.add_argument('--metro', type=str, default='1,10,50')
    parser.add_argument('--reduce', type=str, default='10,20,30,40,50,60,70,80,90,95,99') # 10,20,30,40,50,60,70,80,90,95,99,99.8
    ...
    for m in METRO:
        ...
        for time in range(REPEAT):
            ...
            for r in REDUCE:
                ...
                loss, acc, Hq_iter, data_iter = nnOpt_SQA.FCSQA(layer, reduce=r, metropolis=m, iteration = 100)
                
                loss_untrained.append(loss)
                acc_untrained.append(acc)

                losses_new, accs_new, epoch = nnOpt_SQA.fit(epoch_num=4,  # epoch
                                                            save_step=np.inf)
