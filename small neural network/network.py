...
class Network(nn.Module):
    def __init__(self, in_size, out_size, ratio=[0, 0]):
        super(Network, self).__init__()
        self.fc1 = CustomizedLinear(in_size, 20, 
                                    mask=gen_mask(in_size, 20, ratio[0]))
        self.bn1 = nn.BatchNorm1d(20)
        
        self.fc2 = CustomizedLinear(20, out_size, 
                                    mask=gen_mask(20, out_size, ratio[1]))
